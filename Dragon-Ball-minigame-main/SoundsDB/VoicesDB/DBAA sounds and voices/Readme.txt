Dragon Ball Advanced Adventure (GBA) sounds and voices.
...
I typed
gba_mus_riper DBAA.gba -raw
(instead of DBAA.gba you can have the name of the rom you want to rip sounds from; also, before gba_mus_riper there should be the path to the directory in which the tool is located).
All the rips will be found in a folder called *name of rom*.
